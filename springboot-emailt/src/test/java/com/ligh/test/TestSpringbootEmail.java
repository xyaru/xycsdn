...
public class TestSpringbootEmail {
    ...
    public void sendSimpleMailTest(){
        mailService.sendSimpleMail("1157846759@qq.com","简单文本邮件","这是我的第一封邮件,哈哈...");
    }
    ...
    public void sendHtmlMailTest() throws Exception{
        ...
        mailService.sendHtmlMail("1157846759@qq.com","Html邮件发送",content);
    }
    ...
    public void sendAttachmentMailTest() throws Exception{
        ...
        mailService.sendAttachmentMail("1157846759@qq.com","发送副本","这是一篇带附件的邮件",filepath);
    ...
    public void sendImageMailTest() throws Exception{
        ...
        mailService.sendImageMail("1157846759@qq.com","这是一个带图片的邮件",content,filePath,rscId);
    }
    ...
    public void sendTemplateEmailTest() throws Exception {
        ...
        mailService.sendHtmlMail("1157846759@qq.com","这是一个模板文件",emailContent);
    }
